...
@Component({
  ...
  template: `
    <div class="waiting fade-in">
      ...
      <p class="pid">{{ i18n.t('patientId') }}: <strong>{{ patientId() }}</strong></p>
  ...
  styles: [`
    ...
    h2 { font-size: 1.5rem; color: #2e7d32; margin: 0 0 0.75rem; }
    .pid {
      font-size: 0.95rem; color: #0d47a1;
      background: #e3f2fd; display: inline-block;
      padding: 0.4rem 1rem; border-radius: 8px;
      margin: 0 0 1rem; letter-spacing: 1px;
    }
    .time {
      font-size: 1.25rem; font-weight: 600;
      color: #1a1a1a; margin: 0 0 0.5rem;
    }
    .message {
      font-size: 1.1rem; color: #555; margin: 0 0 1.5rem;
    }
    .checkin-link {
    ...
    .checkin-link:active { background: #1565c0; }
  `],
})
